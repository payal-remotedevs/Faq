...
namespace RD\Faq\EventListener;
...
{
    protected const LLPATH = 'LLL:EXT:faq/Resources/Private/Language/locallang_be.xlf:';
    ...
    {
        $pluginId = str_replace('faq_', '', $record['CType']);
    ...
    {
        $template = GeneralUtility::getFileAbsFileName('EXT:faq/Resources/Private/PluginPreview/PageLayoutView.html');
    ...
    protected function setCategorySettings(array &$data, array $flexFormData): void
    {
        ...
        if (count($categories) > 0) {
            ...
            foreach ($categories as $id) {
                $categoriesOut[] = $this->getRecordData($id, 'tx_faq_domain_model_category');
            }
